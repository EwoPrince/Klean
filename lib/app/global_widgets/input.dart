  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          fillColor: KleanAppColors.greyBG,
          filled: true,
          focusedBorder: OutlineInputBorder(
            borderSide: BorderSide(color: KleanAppColors.secondaryBrandBase, width: 1.0),
            borderRadius: widget.search == true?BorderRadius.circular(40):BorderRadius.circular(10),
          ),
